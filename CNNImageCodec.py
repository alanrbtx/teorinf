...
def ImageCodecModel(trainfolder):
    ...
    # Encoder
    e1 = layers.Conv2D(n1, (7, 7), strides=2, activation="relu", padding="same")(input)
    e2 = layers.Conv2D(n2, (5, 5), strides=2, activation="relu", padding="same")(e1)
    e3 = layers.Conv2D(n3, (3, 3), strides=2, activation="relu", padding="same")(e2)

    # Add noise during training (needed for layer quantization)
